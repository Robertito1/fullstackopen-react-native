        ...
        const repositories = {
          ...
          edges: [
            ...
            },
            {
              ...
              expect(getAllByTestId('forksCount')[0]).toHaveTextContent(toOneDecimal(repositories.edges[0].node.forksCount));
              expect(getAllByTestId('forksCount')[1]).toHaveTextContent(toOneDecimal(repositories.edges[1].node.forksCount)); 

              expect(getAllByTestId('stargazersCount')[0]).toHaveTextContent(toOneDecimal(repositories.edges[0].node.stargazersCount));
              expect(getAllByTestId('stargazersCount')[1]).toHaveTextContent(toOneDecimal(repositories.edges[1].node.stargazersCount)); 
